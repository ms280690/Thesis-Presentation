...
\note[item]{And lastly, the declarative stlye of programming along with the languages in question, \progLang{Haskell} and \progLang{Prolog}.}
\end{itemize}
...
\subsection{Existing and Proposed Work}
...
\subsection{Embedding a Programming Language into another Programming Language}
